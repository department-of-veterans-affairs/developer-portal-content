We've added two restricted access endpoints that allow approved federal consumers to search for Veterans using social security numbers (SSNs), enhancing accessibility while ensuring data privacy.
