We've added two restricted access endpoints that allow government agencies to search for Veterans using social security numbers (SSN), enhancing accessibility while ensuring data privacy.
