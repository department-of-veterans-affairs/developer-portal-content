...
<br>
This API replaces the EVSS Letter Generator Service and offers many added benefits, such as:
...
- Enhanced triage and production support, such as 
  ...
  * contains encrypted versions of the SOAP request/response
...
**There are also some important differences between the VA Letter Generator API and the service it replaces.**
...
- The new API requires OAuth and consumers will not need to pass PII. 
  * Instead, consumers will provide the ICN in each request using a query parameter.
